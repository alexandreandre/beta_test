# scripts/vieillessesalarial/vieillessesalarial_AI.py
...
# --- Constantes ---
SEARCH_QUERY = "taux cotisation assurance vieillesse salariale actuel"
...
def get_taux_vieillesse_salarial_via_ai() -> dict | None:
    """Orchestre la recherche et l'extraction par IA des taux de vieillesse salariaux."""
    prompt_template = """
    Analyse le texte suivant de la section "Taux de cotisations salarié" et extrais les deux taux de la cotisation salariale "Assurance vieillesse" (d'une part le taux plafonné et d'une autre part le taux déplafonné) pour 2025 :
...
def main():
    ...
    taux_data = get_taux_vieillesse_salarial_via_ai()
    ...
    payload = {
        ...
        "meta": {
            ...
            "scraped_at": iso_now(),
            "generator": "scripts/vieillessesalarial/vieillessesalarial_AI.py",
            "method": "ai"
        }
    }
